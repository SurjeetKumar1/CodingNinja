    ...
    <div className='flex mt-24 justify-between item-center pr-8 pl-24'>
      ...
      <div className=' w-[55%]'>
        ...
        <div className=' mt-4 flex flex-col gap-4'>
            <div className=' w-full border-solid  border-[1.5px]  border-white text-2xl font-semibold p-3 rounded-md flex gap-4 justify-start items-center' > <BsCheckCircle className='mt-2'/>Become Ready For Industry With us</div>
            <div  className=' w-full border-solid  border-[1.5px]   border-white text-2xl font-semibold p-3 rounded-md flex gap-4 justify-start items-center'> <BsCheckCircle className='mt-2'/>Regular competition/events</div>
            <div  className=' w-full border-solid  border-[1.5px]   border-white text-2xl font-semibold p-3 rounded-md flex gap-4 justify-start items-center'><BsCheckCircle className='mt-2' />ready to learn and earn</div>
        </div>
      </div>
    </div>
  )
